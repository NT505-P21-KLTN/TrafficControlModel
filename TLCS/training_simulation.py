...
class Simulation:
    ...
    def _replay(self):
        ...
        if len(batch) > 0:  # if the memory is full enough
            ...
            print('set up time:',round(timeit.default_timer()-start_time,1))
            start_time = timeit.default_timer()
            ...
            print('for loop time:',timeit.default_timer()-start_time)
            start_time = timeit.default_timer()
            self._Model.train_batch(x, y)  # train the NN
            print('train batch time: ',timeit.default_timer()-start_time)
